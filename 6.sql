...
-- Dumping data for table psu_blue_cafe.menu: ~3 rows (approximately)
...
-- Dumping data for table psu_blue_cafe.orders: ~2 rows (approximately)
...
-- Dumping data for table psu_blue_cafe.order_details: ~0 rows (approximately)
