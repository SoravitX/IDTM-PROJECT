...
DROP DATABASE IF EXISTS `psu_blue_cafe`;
CREATE DATABASE IF NOT EXISTS `psu_blue_cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `psu_blue_cafe`;
...
INSERT INTO `menu` (`menu_id`, `category_id`, `name`, `price`, `description`, `image`) VALUES
...
INSERT INTO `orders` (`order_id`, `user_id`, `order_time`, `status`, `total_price`) VALUES
...
-- Dumping data for table psu_blue_cafe.users: ~2 rows (approximately)
INSERT INTO `users` (`user_id`, `username`, `password`, `student_ID`, `name`) VALUES
